...
class SpectatorAdapter2 : RecyclerView.Adapter<SpectatorAdapter2.Holder>() {
...
//    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.spectator_item_red, parent, false)
        return Holder(view)
    }
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.spectatorLayoutRed.setOnClickListener {
    ...
    class Holder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var spectatorLayoutRed = itemView.findViewById<ConstraintLayout>(R.id.spectatorLayoutRed)!!
